    ...
    <div className={styles.component}>
      ...
      <section className={styles.container}>
        <div className={styles.event}>
          <p className={styles.eventDate}>Dec 16</p>
          <p className={styles.eventDay}>Sat</p>

          <p className={styles.eventTime}>9:00 am to 3:00 pm</p>

          <p className={styles.eventDesc}>Advent Quiet Day</p>
        </div>
        <div className={styles.event}>
          <p className={styles.eventDate}>Dec 21</p>

          <p className={styles.eventDay}>Thur</p>
          <p className={styles.eventTime}>5:30 pm</p>

          <p className={styles.eventDesc}>Longest Night Service</p>
        </div>
        <div className={styles.event}>
          <p className={styles.eventDate}>Dec 24</p>
          <p className={styles.eventDay}>Sun</p>
          <p className={styles.eventTime}>10:00 am</p>
          <p className={styles.eventDesc}>Sunday Service</p>
        </div>
        <div className={styles.event}>
          <p className={styles.eventDate}>Dec 24</p>
          <p className={styles.eventDay}>Sun</p>
          <p className={styles.eventTime}>11:00 pm</p>
