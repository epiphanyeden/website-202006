    ...
    <div className={styles.outerContainer} id="btt">
      ...
      <div className={styles.textContainer}>
        <p className={styles.smallText}>
          In order to streamline our process and organize inventory, BellTower
        ...
        <p className={styles.smallText}>
          Donations will continue to be accepted through April, as always:
          Tuesdays from 9am to 2:30pm or appointment, by calling 336-623-9410.
        </p>
        <p className={styles.smallText}>
