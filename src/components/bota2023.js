  ...
  return (
    <div className={styles.outerContainer}>
      <div className={styles.textContainer}>
        ...
        <p className={styles.text}> Lots of wonderful pets (and people).</p>
        <p className={styles.text}>
          And{" "}
          <a href="https://www.infinityacres.org/"> Infinity Acres Ranch </a>
          brought a llama and a Patagonian Cava!
        </p>
        <p className={styles.text}>
          Take a look at photos{" "}
          <a href="https://photos.app.goo.gl/qFWeEzt97e4gbV6w6">here.</a>
        </p>
      </div>
    </div>
